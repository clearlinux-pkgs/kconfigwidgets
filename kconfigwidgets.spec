...
Version  : 6.1.0
Release  : 88
URL      : https://download.kde.org/stable/frameworks/6.1/kconfigwidgets-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kconfigwidgets-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kconfigwidgets-6.1.0.tar.xz.sig
...
%setup -q -n kconfigwidgets-6.1.0
cd %{_builddir}/kconfigwidgets-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712965355
mkdir -p clr-build
pushd clr-build
