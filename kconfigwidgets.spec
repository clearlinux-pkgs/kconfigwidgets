...
Source0  : https://download.kde.org/stable/frameworks/5.114/kconfigwidgets-5.114.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.114/kconfigwidgets-5.114.0.tar.xz.sig
...
%prep
%setup -q -n kconfigwidgets-5.114.0
cd %{_builddir}/kconfigwidgets-5.114.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705452905
mkdir -p clr-build
pushd clr-build
