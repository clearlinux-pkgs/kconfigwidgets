...
Source0  : https://download.kde.org/stable/frameworks/5.56/kconfigwidgets-5.56.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.56/kconfigwidgets-5.56.0.tar.xz.sig
...
%prep
%setup -q -n kconfigwidgets-5.56.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1552160157
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5ConfigWidgets.so.5.56.0
