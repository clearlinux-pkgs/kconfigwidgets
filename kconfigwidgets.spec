...
Source0  : https://download.kde.org/stable/frameworks/5.68/kconfigwidgets-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/kconfigwidgets-5.68.0.tar.xz.sig
...
%prep
%setup -q -n kconfigwidgets-5.68.0
cd %{_builddir}/kconfigwidgets-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584312618
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kconfigwidgets-5.68.0/COPYING %{buildroot}/usr/share/package-licenses/kconfigwidgets/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kconfigwidgets-5.68.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kconfigwidgets/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5ConfigWidgets.so.5.68.0
