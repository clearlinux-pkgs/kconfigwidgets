...
Source0  : https://download.kde.org/stable/frameworks/6.3/kconfigwidgets-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/kconfigwidgets-6.3.0.tar.xz.sig
...
%setup -q -n kconfigwidgets-6.3.0
cd %{_builddir}/kconfigwidgets-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717784972
mkdir -p clr-build
pushd clr-build
