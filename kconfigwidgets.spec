...
%setup -q -n kconfigwidgets-6.9.0
cd %{_builddir}/kconfigwidgets-6.9.0
pushd ..
cp -a kconfigwidgets-6.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735244528
mkdir -p clr-build
pushd clr-build
